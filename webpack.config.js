...
const genDirNodeModules = path.join(process.cwd(), 'public', '$$_gendir', 'node_modules');
const entryPoints = ["inline","polyfills","sw-register","styles","vendor","main"];
const minimizeCss = true;
const baseHref = "";
const deployUrl = "";
const projectRoot = "/home/talleane/Documents/@itrulia/nova";
...
module.exports = {
  ...
  "entry": {
    ...
    "styles": [
      "./public/styles.scss",
      "./public/design-system/styles/styleguide.scss"
    ]
  },
  "output": {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "public/styles.scss"),
          path.join(process.cwd(), "public/design-system/styles/styleguide.scss")
        ],
        "test": /\.css$/,
        "use": [
  ...
  "plugins": [
    ...
    new CircularDependencyPlugin({
      ...
      "failOnError": false,
      "onDetected": false,
      "cwd": "/home/talleane/Documents/@itrulia/nova"
    }),
    ...
    new LicenseWebpackPlugin({
      ...
      "outputTemplate": "/home/talleane/Documents/@itrulia/nova/node_modules/license-webpack-plugin/output.template.ejs",
    ...
    new AngularCompilerPlugin({
      ...
      "sourceMap": false,
      "tsConfigPath": "public/tsconfig.app.json",
      "compilerOptions": {}
    })
  ],
  "node": {
